    ...
    context("with valid params") do
      ...
      it "protects against mass assignment" do
        Timecop.freeze(Time.now) do
          game_attributes =
            FactoryBot.attributes_for(:game, created_at: 3.days.ago)
          post(:create, params: { game: game_attributes })
  ...
  describe "show" do
    ...
    it "returns a json response" do
      Timecop.freeze(Time.now) do
        ...
        rating1 =
          FactoryBot.create(:rating, game: game, value: 1003, player: player1)
        rating2 =
          FactoryBot.create(:rating, game: game, value: 1002, player: player2)
        rating3 =
          FactoryBot.create(:rating, game: game, value: 1001, player: player3)
        ...
        result1 =
          FactoryBot.create(
            ...
            game: game,
            teams: [
              FactoryBot.create(:team, rank: 1, players: [player1]),
              FactoryBot.create(:team, rank: 2, players: [player2])
            ]
          )
        result2 =
          FactoryBot.create(
            ...
            game: game,
            teams: [
              FactoryBot.create(:team, rank: 1, players: [player2]),
              FactoryBot.create(:team, rank: 2, players: [player3])
            ]
          )
        result3 =
          FactoryBot.create(
            ...
            game: game,
            teams: [
              FactoryBot.create(:team, rank: 1, players: [player3]),
